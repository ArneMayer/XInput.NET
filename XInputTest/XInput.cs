...
namespace XInputTest
{
    public class XInput
    {
        ...
        public static extern Error XInputGetState(UserIndex userIndex, out State state);
        ...
        /// If the function fails, the return value is an error code defined in WinError.h.</returns>
        [DllImport("xinput1_4.DLL")]
        public static extern Error XInputSetState(UserIndex userIndex, ref Vibration vibration);
        ...
        /// If the function fails, the return value is an error code defined in WinError.h.</returns>
        [DllImport("xinput1_4.DLL")]
        public static extern Error XInputGetCapabilities(UserIndex userIndex, GetCapabilitiesFlags flags, out Capabilities capabilities);
        ...
        /// If there is no headset connected to the controller, the function will also retrieve <see cref="Error.Success"/> with NULL as the values for pRenderDeviceId and pCaptureDeviceId.
        ...
        [DllImport("xinput1_4.DLL")]
        public static extern Error XInputGetAudioDeviceIds(UserIndex userIndex, [MarshalAs(UnmanagedType.LPWStr)] ref string renderDeviceId,
        ...
        [DllImport("xinput1_4.DLL")]
        public static extern Error XInputGetBatteryInformation(UserIndex userIndex, BatteryDeviceType devType, out BatteryInformation batteryInformation);

        /// <summary>
        /// Retrieves a gamepad input event.
        /// </summary>
        /// <param name="userIndex">Index of the signed-in gamer associated with the device. Can be a value in the range 0–<see cref="UserIndex.MaxCount"/> − 1, or <see cref="UserIndex.Any"/> to fetch the next available input event from any user.</param>
        ...
        /// If the function fails, the return value is an error code defined in Winerror.h.</returns>
        [DllImport("xinput1_4.DLL")]
        public static extern Error XInputGetKeystroke(UserIndex userIndex, GetKeyStrokeFlags reserved, out KeyStroke pKeystroke);
